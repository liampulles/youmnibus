...
kubectl create --namespace=youmnibus secret generic shared-bootstrap-data --from-file=internal-auth-mongodb-keyfile=$TMPFILE
rm $TMPFILE
...
kubectl apply --namespace=youmnibus  -f ../resources/mongodb-service.yaml --validate=false
sleep 5
